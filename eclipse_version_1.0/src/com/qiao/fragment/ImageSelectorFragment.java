...
import com.qiao.activity.ImageBrowserActivity;
...
public class ImageSelectorFragment extends Fragment  implements AbsListView.OnScrollListener{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		initData();
		return rootView=inflater.inflate(R.layout.activity_image_selector,null);
	}
	...
	private void initListeners() {
		...
		browserView.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent intent = DemoActivity.makeIntent(getActivity(), ImageBrowserFragment.class);// new Intent(getActivity(),ImageBrowserActivity.class);
